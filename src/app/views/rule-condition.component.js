...
var RuleConditionComponent = (function () {
    ...
    RuleConditionComponent.prototype.checkSaveNeeded = function () {
        ...
        if (this.uiCondition != this.condition.condition) {
            needed = true;
        }
        if ((this.condition instanceof rule_conditions_1.StateCondition) ||
            (this.condition instanceof rule_conditions_1.NumericStateCondition) ||
            (this.condition instanceof rule_conditions_1.ZoneCondition)) {
            if (this.uiEntityId != this.condition.entity_id) {
                needed = true;
            }
        }
        if (this.condition instanceof rule_conditions_1.StateCondition) {
            if (this.uiState != this.condition.state) {
                needed = true;
            }
        }
        else if (this.condition instanceof rule_conditions_1.NumericStateCondition) {
            if (this.uiAboveValue != this.condition.above_value) {
                needed = true;
            }
            if (this.uiBelowValue != this.condition.below_value) {
                needed = true;
            }
        }
        else if (this.condition instanceof rule_conditions_1.SunCondition) {
            if (this.uiSunAfter != this.condition.after) {
                needed = true;
            }
            if (this.uiSunAfterOffset != this.condition.after_offset) {
                needed = true;
            }
            if (this.uiSunBefore != this.condition.before) {
                needed = true;
            }
            if (this.uiSunBeforeOffset != this.condition.before_offset) {
                needed = true;
            }
        }
        else if (this.condition instanceof rule_conditions_1.TimeCondition) {
            if (this.uiTimeAfter != this.condition.after) {
                needed = true;
            }
            if (this.uiTimeBefore != this.condition.before) {
                needed = true;
            }
            if (this.uiTimeWeekday != this.condition.weekday) {
                needed = true;
            }
        }
        else if (this.condition instanceof rule_conditions_1.ZoneCondition) {
            if (this.uiZone != this.condition.zone) {
                needed = true;
            }
        }
        else if ((this.condition instanceof rule_conditions_1.AndCondition) ||
            (this.condition instanceof rule_conditions_1.OrCondition)) {
            if (this.uiNestedConditions.length != this.condition.conditions.length) {
                needed = true;
            }
        }
