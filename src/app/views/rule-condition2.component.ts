...
//   }
  ...
  onAddClick(): void {
    ...
    if ((this.condition instanceof AndCondition) || (this.condition instanceof OrCondition)) {
      if (this.condition.conditions == null) {
        this.condition.conditions = []; 
      }
      // Use AndCondition as a placeholder condition since its very simple
      this.condition.conditions.push(new AndCondition());   
    }
  }
